# pip install pandas Image imageio plotly
...
df = pd.read_csv("tests\\test_data\\EURUSD\\EURUSD_M15_202407010000_202501292030.csv")
window_df = df.iloc[-1000:]
# print df coluimns
print(df.columns)

swing_highs_lows_data = smc.swing_highs_lows(window_df, swing_length=5)

window_df.to_csv("swing_highs_lows solos.csv")
# merge swing_highs_lows_data and window_df based on the common index
window_df = pd.concat([window_df, swing_highs_lows_data], axis=1)

window_df.to_csv("window_df + swing_highs_lows.csv")
